#
#  Be sure to run `pod spec lint Mypodframework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/Mypodframework"
  ...
  # Or just: s.author    = "Rasul Sultanbekov"
  # s.authors            = { "Rasul Sultanbekov" => "rasul.sultanbekov@zensoft.io" }
  # s.social_media_url   = "http://twitter.com/Rasul Sultanbekov"
